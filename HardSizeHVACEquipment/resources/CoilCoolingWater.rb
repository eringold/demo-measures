  ...
  def autosizedDesignAirFlowRate
    ...
    if sql.is_initialized
      ...
      query = "SELECT Value
              ...
              AND TableName='Coil:Cooling:Water'
              AND RowName='#{name}'
              AND ColumnName='Design Size Design Air Flow Rate'
              AND Units='m3/s'"
  ...
  def autosizedDesignInletWaterTemperature
    ...
    if sql.is_initialized
      ...
      query = "SELECT Value
              ...
              AND TableName='Coil:Cooling:Water'
              AND RowName='#{name}'
              AND ColumnName='Design Size Design Inlet Water Temperature'
              AND Units='C'"
  ...
  def autosizedDesignInletAirTemperature
    ...
    if sql.is_initialized
      ...
      query = "SELECT Value
              ...
              AND TableName='Coil:Cooling:Water'
              AND RowName='#{name}'
              AND ColumnName='Design Size Design Inlet Air Temperature'
              AND Units='C'"
  ...
  def autosizedDesignOutletAirTemperature
    ...
    if sql.is_initialized
      ...
      query = "SELECT Value
              ...
              AND TableName='Coil:Cooling:Water'
              AND RowName='#{name}'
              AND ColumnName='Design Size Design Outlet Air Temperature'
              AND Units='C'"
  ...
  def autosizedDesignInletAirHumidityRatio
    ...
    if sql.is_initialized
      ...
      query = "SELECT Value
              ...
              AND TableName='Coil:Cooling:Water'
              AND RowName='#{name}'
              AND ColumnName='Design Size Design Inlet Air Humidity Ratio'"
  ...
  def autosizedDesignOutletAirHumidityRatio
    ...
    if sql.is_initialized
      ...
      query = "SELECT Value
              ...
              AND TableName='Coil:Cooling:Water'
              AND RowName='#{name}'
              AND ColumnName='Design Size Design Outlet Air Humidity Ratio'"
