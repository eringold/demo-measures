  ...
  def autosizedReferenceChilledWaterFlowRate
    ...
    if sql.is_initialized
      ...
      query = "SELECT Value
              ...
              AND RowName='#{name}'
              AND ColumnName='Design Size Reference Chilled Water Flow Rate'
              AND Units='m3/s'"
  ...
  def autosizedReferenceCapacity
    ...
    if sql.is_initialized
      ...
      query = "SELECT Value
              ...
              AND TableName='Chiller:Electric:EIR'
              AND RowName='#{name}'
              AND ColumnName='Design Size Reference Capacity'
              AND Units='W'"
  ...
  def autosizedReferenceCondenserFluidFlowRate
    ...
    if sql.is_initialized
      ...
      query = "SELECT Value
              ...
              AND TableName='Chiller:Electric:EIR'
              AND RowName='#{name}'
              AND ColumnName='Design Size Reference Condenser Water Flow Rate'
              AND Units='m3/s'"
